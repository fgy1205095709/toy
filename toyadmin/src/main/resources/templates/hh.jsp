...
<head>
    ...
    <link rel="stylesheet" href="http://res.layui.com/layui/dist/css/layui.css?t=1575404972583" media="all">
    <style>
        body{margin: 10px;}
        .demo-carousel{height: 300px; line-height: 200px; text-align: center;}
    </style>
...
<script src="//res.layui.com/layui/dist/layui.js?t=1575404972583"></script>
        ...
        table.render({
            ...
            ,cols: [
                [ //表头
                    ...
                    {field: 'lId', title: 'ID', width:80, sort: true, fixed: 'left',id:'lId'},
